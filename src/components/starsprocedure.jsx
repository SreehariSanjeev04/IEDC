function Procedure() {
    return (
        <div className="w-full bg-cream text-center px-10 py-12 space-y-5">
            ...
            <p className="text-md md:text-xl">No matter how you pay, you can earn Stars with your morning coffee. Those Stars add up to (really delicious) Rewards.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 place-content-start pt-10">
                ...
                <div className="flex gap-x-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-md md:text-lg text-left pb-3">Use cash or credit/debit card at the register.</p>
                    </div>
                </div>
                <div className="flex gap-x-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-md md:text-lg text-left">Check-out faster by saving a credit/debit card or PayPal to your account. You’ll be able to order ahead or scan and pay at the register in one step.</p>
                    </div>
                </div>
            </div>
            <hr />
            <div className="grid grid-cols-1 md:grid-cols-3 place-content-start pt-10">
                ...
                <div className="flex gap-x-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-md md:text-lg text-left">To save time and earn Stars twice as fast, add money to your digital Starbucks Card using any payment option. Scan and pay in one step or order ahead in the app.</p>
                    </div>
                </div>
                <div className="flex gap-x-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-md md:text-lg text-left">Then use it to pay through the app. You can even consolidate balances from multiple cards in one place.</p>
                    </div>
                </div>
            </div>
        </div>
